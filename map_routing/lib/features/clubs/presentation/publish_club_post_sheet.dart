...
Future<bool?> showPublishClubPostSheet(
  ...
  return showModalBottomSheet<bool>(
    ...
    builder: (context) => PublishClubPostSheet(
...
class PublishClubPostSheet extends StatefulWidget {
  const PublishClubPostSheet({
    super.key,
  ...
  @override
  State<PublishClubPostSheet> createState() => _PublishClubPostSheetState();
}

class _PublishClubPostSheetState extends State<PublishClubPostSheet> {
  ...
  Future<void> _publish() async {
    ...
    try {
      await widget.clubService.publishPost(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Поделитесь чем-нибудь...',
                filled: true,
