...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.yandex.maps.flutter.YandexMapsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin yandex_maps_mapkit, com.yandex.maps.flutter.YandexMapsPlugin", e);
    }
  }
}
